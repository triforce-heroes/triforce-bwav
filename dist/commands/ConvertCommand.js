...
- ${r}... INVALID
`);continue}let n=S[g.get(p)],f=n.items[0].value,l=f.items.length,u=4===f.items[0].items.length,a=m(m(o.slice(4))),h=`${a}${r}.c.bwav`,b=!0===C.force||!s(h)||v(o,h);if(b&&process.stdout.write(`
- [${u?"D":"L"}${String(l)}] ${r}... `),u)b&&d(o,h,l),y(n,i(h));else{b&&w(o,h,l);let e=i(h);$(n,e,e.readUInt32LE(24),l)}L.file(h,{name:`romfs/Voice/Resource/USen/${p}.bwav`}),b&&process.stdout.write("OK\n")}process.stdout.write(`
`),process.stdout.write("Patching YAML... ");let O=b(),I=a(O),T=h(I);L.file(T,{name:"romfs/Voice/BwavInfo/USen.byml.zs"}),!0===C.keepTemps&&o(O,"USen.yaml",{force:!0}),p(O),p(I),process.stdout.write(`OK
